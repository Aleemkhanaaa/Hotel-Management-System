...
public class Events extends JFrame {
	...
	public Events() {
		...
		JLabel lblRoomsOrHotel = new JLabel("                       EVENTS BOOKING");
		...
		JLabel lblFloor = new JLabel("EVENT");
		...
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\f\\eclipse-workspace\\MY SCD PROJECT\\pics use\\photo-1577784019900-819f658f8ac1.jpg"));
		lblNewLabel_3.setBounds(51, 101, 215, 292);
		...
		Vcheck.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				V1.setText("PERSONS  :" +v1.getText());
				V2.setText("EVENT  :" +v2.getText());
				V34.setText("DATE  :" +v3.getText()+ "-"+v4.getText()+"-2021");
				V5.setText("PHONE NO.  :" +v5.getText());
			}
		});
		...
		lblNewLabel_4.setIcon(new ImageIcon("C:\\Users\\f\\eclipse-workspace\\MY SCD PROJECT\\pics use\\photo-1468359601543-843bfaef291a.jpg"));
		lblNewLabel_4.setBounds(0, 0, 660, 458);
