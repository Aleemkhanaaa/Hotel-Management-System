...
public class AfterLoginMainManu extends JFrame {
	...
	public AfterLoginMainManu() {
		...
		btnVehicleOrCar.setBounds(85, 160, 453, 39);
		contentPane.add(btnVehicleOrCar);
		
		JButton btnMealifYou = new JButton("MEAL (if you stay in our hotel)");
		btnMealifYou.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new Meal().setVisible(true);
			}
		});
		btnMealifYou.setFont(new Font("Times New Roman", Font.BOLD, 20));
		btnMealifYou.setBounds(85, 218, 453, 39);
		contentPane.add(btnMealifYou);
		...
		btnEventsBooking.setBounds(85, 277, 453, 39);
		...
		btnBackToHome.setBounds(196, 349, 251, 39);
